...
const schema = yup.object().shape({
	...
	email: yup.string().trim().required('Поле обязательно для заполнения').matches(/^([a-zA-Z0-9_-]+\.)*[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)*\.[a-zA-Z0-9]{1,20}$/, 'Введите корректный email'),
